...
public class FEXResponse_DST_pais  implements java.io.Serializable {
    private fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_pais[] FEXResultGet;
    ...
    public FEXResponse_DST_pais(
           fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_pais[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_pais[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_pais[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_DST_pais)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_DST_pais.class, true);
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_DST_pais"));
