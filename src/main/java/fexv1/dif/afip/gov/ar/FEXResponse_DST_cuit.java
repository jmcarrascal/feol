...
public class FEXResponse_DST_cuit  implements java.io.Serializable {
    private fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_cuit[] FEXResultGet;
    ...
    public FEXResponse_DST_cuit(
           fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_cuit[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_cuit[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fexv1.dif.afip.gov.ar.ClsFEXResponse_DST_cuit[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
