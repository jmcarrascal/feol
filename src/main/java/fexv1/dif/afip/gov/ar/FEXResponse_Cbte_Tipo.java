...
public class FEXResponse_Cbte_Tipo  implements java.io.Serializable {
    private fexv1.dif.afip.gov.ar.ClsFEXResponse_Cbte_Tipo[] FEXResultGet;
    ...
    public FEXResponse_Cbte_Tipo(
           fexv1.dif.afip.gov.ar.ClsFEXResponse_Cbte_Tipo[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fexv1.dif.afip.gov.ar.ClsFEXResponse_Cbte_Tipo[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fexv1.dif.afip.gov.ar.ClsFEXResponse_Cbte_Tipo[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_Cbte_Tipo)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_Cbte_Tipo.class, true);
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Cbte_Tipo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Cbte_Tipo"));
