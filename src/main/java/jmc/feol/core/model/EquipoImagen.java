...
@Entity
@Table(name="EQUIPOIMAGEN")
//@Table(name="EQUIPOIMAGEN", schema = "Feol_Gamma.dbo")
public class EquipoImagen {

	private Long idEquipoImagen;
	private String ip;
	...
	public Long getIdEquipoImagen() {
		return idEquipoImagen;
	}
	public void setIdEquipoImagen(Long idEquipoImagen) {
		this.idEquipoImagen = idEquipoImagen;
	}
	public String getIp() {
		return ip;
	}
