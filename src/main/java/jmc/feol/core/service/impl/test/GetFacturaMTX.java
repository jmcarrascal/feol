	...
	private static String castArrayToString(CodigoDescripcionType[] arrayErrores) {
	  ...
	  public static void main (String args[]) {
		...
		try {
			...
			BaseExternaMTX be = new BaseExternaMTX("net.sourceforge.jtds.jdbc.Driver","jdbc:jtds:sqlserver://190.16.221.229:1433/TransacSql", "Comunsql.dbo", "ComunSql.dbo", "sa", "drofarsak05");
			
			ComprobanteType feab = be.getFacturaExt(5499921l, "transacsql");
