...
public class TestParseCamposCertificado {
	...
	public static void main(String[] args){
		String c = "AR";
		String o = "Ministerio P�blico de la Provincia de Buenos Aires";
		String ou = "Se desempe�a como Oficial 4 en la oficina FISCALIA GENERAL - Oficina de Archivo";
		String cn = "Carlos Gomez";
		String e = "cgomez@mpba.gov.ar";
		
		String sn = "C=AR, O=Ministerio P�blico de la Provincia de Buenos Aires, OU=Se desempe�a como Oficial 4 en la oficina FISCALIA GENERAL - Oficina de Archivo, CN=Carlos Gomez, EMAILADDRESS=cgomez@mpba.gov.ar";
		/*
		 
		 Validar que el usuario se desempe�a en la oficina "A"		 
		 1- validar que el texto primero es "Se desempe�a como "
	...
	private static Usuario integridadOrganismoOrganizacional(String ou) {
		...
		try{
			String[] parrafos = ou.split("Se desempe�a como ");
