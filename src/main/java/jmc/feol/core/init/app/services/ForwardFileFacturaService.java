...
public class ForwardFileFacturaService implements Runnable {
	...
	public void run() {
		...
		try {
			...
			.getByPrimaryKey(Constants.ID_USO_LISTENERFORWARDFFILEACTURA)
			.getValor().trim().equals("true");
			if (useService) {
				System.out.println("Inicio ListenerForwardFileFactura");
				Long periodo = 200000l;
