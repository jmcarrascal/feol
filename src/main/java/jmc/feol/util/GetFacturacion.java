...
public static Empresa getCredencial(){
		...
		empresa.setCuit("33710828259");
		empresa.setNombre("Clue");
		...
		empresa.setP12File("C:/Certificados/clue/clue1.p12");
		empresa.setP12pass("123456");
		empresa.setTicketTime(36000000l);
		empresa.setSigner("clue");
	...
	public static void main(String[] args) {
        ...
        short nro_fila = 0;
		for(Integer tipo_comprob : getTipoComprob()){
			...
			while(!end_facturacion){
				...
				if (res != null){		
					...
					try{
						...
						if (fecha > 20130101000000l){
							end_facturacion = true;
						}
						if (fecha > 20111231000000l && fecha < 20130101000000l){
