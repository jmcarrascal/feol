...
public class ConsultarAlicuotasIVAResponseType  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] arrayAlicuotasIVA;
    ...
    public ConsultarAlicuotasIVAResponseType(
           FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] arrayAlicuotasIVA,
     ...
     */
    public FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] getArrayAlicuotasIVA() {
        return arrayAlicuotasIVA;
    }
     ...
     */
    public void setArrayAlicuotasIVA(FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] arrayAlicuotasIVA) {
        this.arrayAlicuotasIVA = arrayAlicuotasIVA;
    }
