...
public class ConsultarCAEAEntreFechasResponseType  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.wmtx.CAEAResponseType[] arrayCAEAResponse;
    ...
    public ConsultarCAEAEntreFechasResponseType(
           FEV1.dif.afip.gov.ar.wmtx.CAEAResponseType[] arrayCAEAResponse,
     ...
     */
    public FEV1.dif.afip.gov.ar.wmtx.CAEAResponseType[] getArrayCAEAResponse() {
        return arrayCAEAResponse;
    }
     ...
     */
    public void setArrayCAEAResponse(FEV1.dif.afip.gov.ar.wmtx.CAEAResponseType[] arrayCAEAResponse) {
        this.arrayCAEAResponse = arrayCAEAResponse;
    }
