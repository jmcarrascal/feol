...
public class ConsultarCondicionesIVAResponseType  implements java.io.Serializable {
    private FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] arrayCondicionesIVA;
    ...
    public ConsultarCondicionesIVAResponseType(
           FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] arrayCondicionesIVA,
     ...
     */
    public FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] getArrayCondicionesIVA() {
        return arrayCondicionesIVA;
    }
     ...
     */
    public void setArrayCondicionesIVA(FEV1.dif.afip.gov.ar.wmtx.CodigoDescripcionType[] arrayCondicionesIVA) {
        this.arrayCondicionesIVA = arrayCondicionesIVA;
    }
