...
public class MTXCAServiceLocator extends org.apache.axis.client.Service implements FEV1.dif.afip.gov.ar.wmtx.MTXCAService {

    public MTXCAServiceLocator() {
    }
    public MTXCAServiceLocator(String urlWS) {
    	MTXCAServiceHttpSoap11Endpoint_address = urlWS;
    }
    ...
    //private java.lang.String MTXCAServiceHttpSoap11Endpoint_address = "http://localhost:8990/wsmtxca/services/MTXCAService";
    ...
    public FEV1.dif.afip.gov.ar.wmtx.MTXCAServicePortType getMTXCAServiceHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public FEV1.dif.afip.gov.ar.wmtx.MTXCAServicePortType getMTXCAServiceHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            FEV1.dif.afip.gov.ar.wmtx.MTXCAServiceSoap11BindingStub _stub = new FEV1.dif.afip.gov.ar.wmtx.MTXCAServiceSoap11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (FEV1.dif.afip.gov.ar.wmtx.MTXCAServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                FEV1.dif.afip.gov.ar.wmtx.MTXCAServiceSoap11BindingStub _stub = new FEV1.dif.afip.gov.ar.wmtx.MTXCAServiceSoap11BindingStub(new java.net.URL(MTXCAServiceHttpSoap11Endpoint_address), this);
                _stub.setPortName(getMTXCAServiceHttpSoap11EndpointWSDDServiceName());
                return _stub;
            }
        }
