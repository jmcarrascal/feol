...
public class FEXResponse_IdiDesa  implements java.io.Serializable {
    private fex.dif.afip.gov.ar.ClsFEXResponse_IdiDesa[] FEXResultGet;

    private fex.dif.afip.gov.ar.ClsFEXErrDesa FEXErr;

    private fex.dif.afip.gov.ar.ClsFEXEventsDesa FEXEvents;

    public FEXResponse_IdiDesa() {
    }

    public FEXResponse_IdiDesa(
           fex.dif.afip.gov.ar.ClsFEXResponse_IdiDesa[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fex.dif.afip.gov.ar.ClsFEXResponse_IdiDesa[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fex.dif.afip.gov.ar.ClsFEXResponse_IdiDesa[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_IdiDesa)) return false;
        FEXResponse_IdiDesa other = (FEXResponse_IdiDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_IdiDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "FEXResponse_Idi"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_Idi"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_Idi"));
