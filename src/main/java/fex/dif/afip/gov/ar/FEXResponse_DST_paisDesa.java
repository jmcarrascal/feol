...
public class FEXResponse_DST_paisDesa  implements java.io.Serializable {
    private fex.dif.afip.gov.ar.ClsFEXResponse_DST_paisDesa[] FEXResultGet;

    private fex.dif.afip.gov.ar.ClsFEXErrDesa FEXErr;

    private fex.dif.afip.gov.ar.ClsFEXEventsDesa FEXEvents;

    public FEXResponse_DST_paisDesa() {
    }

    public FEXResponse_DST_paisDesa(
           fex.dif.afip.gov.ar.ClsFEXResponse_DST_paisDesa[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fex.dif.afip.gov.ar.ClsFEXResponse_DST_paisDesa[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fex.dif.afip.gov.ar.ClsFEXResponse_DST_paisDesa[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_DST_paisDesa)) return false;
        FEXResponse_DST_paisDesa other = (FEXResponse_DST_paisDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_DST_paisDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "FEXResponse_DST_pais"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_DST_pais"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_DST_pais"));
