...
public class FEXResponse_IncDesa  implements java.io.Serializable {
    private fex.dif.afip.gov.ar.ClsFEXResponse_IncDesa[] FEXResultGet;

    private fex.dif.afip.gov.ar.ClsFEXErrDesa FEXErr;

    private fex.dif.afip.gov.ar.ClsFEXEventsDesa FEXEvents;

    public FEXResponse_IncDesa() {
    }

    public FEXResponse_IncDesa(
           fex.dif.afip.gov.ar.ClsFEXResponse_IncDesa[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fex.dif.afip.gov.ar.ClsFEXResponse_IncDesa[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fex.dif.afip.gov.ar.ClsFEXResponse_IncDesa[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_IncDesa)) return false;
        FEXResponse_IncDesa other = (FEXResponse_IncDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_IncDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "FEXResponse_Inc"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_Inc"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_Inc"));
