...
public class ClsFEX_LastCMP_ResponseDesa  implements java.io.Serializable {
    private long cbte_nro;

    private java.lang.String cbte_fecha;

    public ClsFEX_LastCMP_ResponseDesa() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClsFEX_LastCMP_ResponseDesa)) return false;
        ClsFEX_LastCMP_ResponseDesa other = (ClsFEX_LastCMP_ResponseDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClsFEX_LastCMP_ResponseDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEX_LastCMP_Response"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "Cbte_fecha"));
