...
public class FEXGetCMPResponseDesa  implements java.io.Serializable {
    private fex.dif.afip.gov.ar.ClsFEXGetCMPRDesa FEXResultGet;

    private fex.dif.afip.gov.ar.ClsFEXErrDesa FEXErr;

    private fex.dif.afip.gov.ar.ClsFEXEventsDesa FEXEvents;

    public FEXGetCMPResponseDesa() {
    }

    public FEXGetCMPResponseDesa(
           fex.dif.afip.gov.ar.ClsFEXGetCMPRDesa FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fex.dif.afip.gov.ar.ClsFEXGetCMPRDesa getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fex.dif.afip.gov.ar.ClsFEXGetCMPRDesa FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXGetCMPResponseDesa)) return false;
        FEXGetCMPResponseDesa other = (FEXGetCMPResponseDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXGetCMPResponseDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "FEXGetCMPResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXGetCMPR"));
