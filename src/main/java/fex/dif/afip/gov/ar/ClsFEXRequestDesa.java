...
public class ClsFEXRequestDesa  implements java.io.Serializable {
    private long id;
    ...
    private String errorParceso = null;
    ...
    public String getErrorParceso() {
		return errorParceso;
	}

	public void setErrorParceso(String errorParceso) {
		this.errorParceso = errorParceso;
	}

	private fex.dif.afip.gov.ar.ItemDesa[] itemDesas;

    public ClsFEXRequestDesa() {
    }
    ...
    /**
     * Gets the tipo_cbte value for this ClsFEXRequest.
     * 
     * @return tipo_cbte
     */
    ...
    /**
     * Sets the tipo_cbte value for this ClsFEXRequest.
     * 
     * @param tipo_cbte
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClsFEXRequestDesa)) return false;
        ClsFEXRequestDesa other = (ClsFEXRequestDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClsFEXRequestDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXRequest"));
