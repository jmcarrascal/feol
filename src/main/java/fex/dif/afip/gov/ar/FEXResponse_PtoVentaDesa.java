...
public class FEXResponse_PtoVentaDesa  implements java.io.Serializable {
    private fex.dif.afip.gov.ar.ClsFEXResponse_PtoVentaDesa[] FEXResultGet;

    private fex.dif.afip.gov.ar.ClsFEXErrDesa FEXErr;

    private fex.dif.afip.gov.ar.ClsFEXEventsDesa FEXEvents;

    public FEXResponse_PtoVentaDesa() {
    }

    public FEXResponse_PtoVentaDesa(
           fex.dif.afip.gov.ar.ClsFEXResponse_PtoVentaDesa[] FEXResultGet,
     ...
     * @return FEXResultGet
     */
    public fex.dif.afip.gov.ar.ClsFEXResponse_PtoVentaDesa[] getFEXResultGet() {
        return FEXResultGet;
    }
     ...
     * @param FEXResultGet
     */
    public void setFEXResultGet(fex.dif.afip.gov.ar.ClsFEXResponse_PtoVentaDesa[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_PtoVentaDesa)) return false;
        FEXResponse_PtoVentaDesa other = (FEXResponse_PtoVentaDesa) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_PtoVentaDesa.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "FEXResponse_PtoVenta"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_PtoVenta"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ClsFEXResponse_PtoVenta"));
