...
public class ServiceLocatorDesa extends org.apache.axis.client.Service implements fex.dif.afip.gov.ar.ServiceDesa {
 ...
 */
    ...
    public ServiceLocatorDesa() {
    }
    public ServiceLocatorDesa(String urlWS) {
    	ServiceSoap_address = urlWS;
    }

    public ServiceLocatorDesa(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public ServiceLocatorDesa(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for ServiceSoap
    private java.lang.String ServiceSoap_address = "https://servicios1.afip.gov.ar/wsfex/service.asmx";
    //private java.lang.String ServiceSoap_address = "https://wswhomo.afip.gov.ar/wsfex/service.asmx";
    
    public java.lang.String getServiceSoapAddress() {
        System.out.println("URL del Servcio invocado: " + ServiceSoap_address);
    ...
    public fex.dif.afip.gov.ar.ServiceSoapDesa getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fex.dif.afip.gov.ar.ServiceSoapStubDesa _stub = new fex.dif.afip.gov.ar.ServiceSoapStubDesa(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "https://wswhomo.afip.gov.ar/wsfex/service.asmx";
    ...
    public fex.dif.afip.gov.ar.ServiceSoapDesa getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fex.dif.afip.gov.ar.ServiceSoap12StubDesa _stub = new fex.dif.afip.gov.ar.ServiceSoap12StubDesa(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fex.dif.afip.gov.ar.ServiceSoapDesa.class.isAssignableFrom(serviceEndpointInterface)) {
                fex.dif.afip.gov.ar.ServiceSoapStubDesa _stub = new fex.dif.afip.gov.ar.ServiceSoapStubDesa(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (fex.dif.afip.gov.ar.ServiceSoapDesa.class.isAssignableFrom(serviceEndpointInterface)) {
                fex.dif.afip.gov.ar.ServiceSoap12StubDesa _stub = new fex.dif.afip.gov.ar.ServiceSoap12StubDesa(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ServiceSoap"));
            ports.add(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fex/", "ServiceSoap12"));
        }
