	...
	<div class="panel_50 tab">
		...
		<fieldset class="defaultFieldset"  >
			...
			<div class="space"></div>
				...
				<s:form action="editEmpresa" id="addEmpresaForm" method="post" >
						
					<table>
						<tr>
		 						 				
							<td><s:textfield id="idEmpresa" name="empresa.idEmpresa" size="50" maxlength="50" label="ID" readonly="true"/></td>
						</tr>
						<tr>
