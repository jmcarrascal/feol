...
<head>
	...
	<sj:head useJqGridPlugin="true" jqueryui="true" jquerytheme="smoothness" customBasepath="themes" />
...
<!--		<link href="<%=request.getContextPath()%>/css/blockuiv1.css" rel="stylesheet" type="text/css" />-->
		<link href="<%=request.getContextPath()%>/css/defaultForm.css" rel="stylesheet" type="text/css" />
...
<!-- 		<script src="<%=request.getContextPath()%>/js/jquery.js"	type="text/javascript"></script>-->		 
 		...
 		<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-ui-1.7.2.min.js"></script>
